...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-obsidian-900 p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="space-y-2 z-10">
            ...
            <p className="text-xs text-gray-400 max-w-xl leading-relaxed">
              Welcome to the Recruitment Portal. You have <span className="text-brand-teal font-semibold">{totalApplicants} applicants</span> in the pipeline. Review matches below.
            </p>
          </div>
      ...
      {/* Numerical Stats Blocks with Stagger and Pop */}
      <StaggerContainer staggerDelay={0.08} className="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <ScrollReveal variant="slide-up" delay={0.1} className="lg:col-span-2 space-y-6">
          <Card className="p-6">
        ...
        <ScrollReveal variant="slide-right" delay={0.15} className="space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-obsidian-900 border border-white/[0.04] rounded-lg flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-semibold text-white truncate">Priya Ramesh (Shortlisted)</p>
              ...
              <div className="p-3 bg-obsidian-900 border border-white/[0.04] rounded-lg flex items-start gap-3 opacity-60">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-semibold text-white truncate">Divya Kannan (Shortlisted)</p>
