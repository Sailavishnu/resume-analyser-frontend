...
import { ShieldCheck, User, Users, Briefcase, Mail, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen w-screen flex bg-obsidian-950 text-gray-200">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-obsidian-900 border-r border-white/[0.06] p-12 flex-col justify-between relative bg-grid-pattern overflow-hidden">
        ...
        <div className="flex items-center gap-2.5 z-10">
          <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-brand-blue to-brand-violet flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-brand-indigo/15">
            A
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        {/* Glow Spheres for mobile screen bg */}
        ...
        <div className="w-full max-w-sm flex flex-col z-10">
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold font-heading text-white mb-1.5">Sign In</h2>
            <p className="text-xs text-gray-400">Welcome back. Enter your credentials to access your portal.</p>
          </div>

          {/* Role selector buttons */}
          <div className="grid grid-cols-2 gap-2.5 p-1 rounded-xl bg-obsidian-900 border border-white/[0.06] mb-6">
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input
                  type="checkbox"
                  className="rounded bg-obsidian-900 border-white/[0.08] text-brand-blue focus:ring-0 cursor-pointer"
                  defaultChecked
                />
                <span>Remember me</span>
              </label>
              <a href="#forgot" className="text-brand-blue hover:underline">Forgot password?</a>
            </div>
