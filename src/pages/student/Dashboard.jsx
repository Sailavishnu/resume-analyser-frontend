...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* ATS Score card */}
        <Card hoverEffect className="flex items-center gap-6 justify-between p-6">
        ...
        {/* Daily Goal Card */}
        <Card hoverEffect className="p-6 flex flex-col justify-between relative overflow-hidden">
